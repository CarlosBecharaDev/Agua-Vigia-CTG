...
| D1 (Rafael) | RF013 (completo) · RF015 | `GET /api/suscripciones/confirmar` (token de un solo uso, doble opt-in real) y `GET /api/suscripciones/cancelar` (baja en 1 clic). `SuscribirseService` y la plantilla de correo ya existen | C1 ✅ · `SuscribirseService` ✅ (Sprint 1, PR #78) |
