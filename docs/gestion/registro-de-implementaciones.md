...
| RF016 · RF017 · RF018 | func | M5 frontend integrado: panel autenticado del veedor contra las API reales para moderar reportes y listar, registrar y cerrar cortes oficiales con varios sectores. Sin datos simulados; conserva JWT en `sessionStorage` y errores RFC 7807 | D4 (José) | [#132](https://github.com/CarlosBecharaDev/Agua-Vigia-CTG/pull/132) | Frontend: `api:check`, lint, **35 pruebas** y build en verde |
| RF020–RF022 · RF026 · RF027 | func | M6/M8 frontend integrado: índice global y por sector desde `/api/cumplimiento`, y bitácora pública append-only desde `/api/bitacora`. Valida las respuestas en ejecución y no calcula ni inventa cifras en el navegador | D4 (José) | [#132](https://github.com/CarlosBecharaDev/Agua-Vigia-CTG/pull/132) | Pruebas de rutas exactas, contratos incompletos, representación del índice y eventos públicos |
