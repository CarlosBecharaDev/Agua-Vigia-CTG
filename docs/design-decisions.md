...
Este PR usa `ADR-016` porque el PR #56 (Sprint 1 de D3, sin fusionar) ya reservó `ADR-014` y
`ADR-015`. Si #56 se fusiona primero, no hay colisión. Si este PR se fusiona primero, renumerar
antes de que #56 entre a `develop`.
