 ...
 * Si la API no responde, muestra "sin datos" en vez de inventar eventos.
 */
          ...
          <span style={{ fontSize: '0.75rem', fontWeight: '700', color: usandoDatosReales ? '#30d158' : '#ff453a', textTransform: 'uppercase', letterSpacing: '0.5px' }}>
            {cargando 
              ...
              : usandoDatosReales 
                ...
                : 'SIN DATOS (Sin conexión con Acuacar)'}
          </span>
        </div>
          ...
          {usandoDatosReales ? (
            ...
            >
              ...
              <span style={{ fontSize: '1.05rem', fontWeight: '500' }}>
                {cargando ? 'Cargando boletines…' : 'No hay conexión con Acuacar en este momento.'}
              </span>
              {!cargando && (
                <span style={{ fontSize: '0.85rem', color: 'var(--color-tinta-3)' }}>
                  No se muestran eventos hasta poder verificarlos contra un boletín real.
                </span>
              )}
            </div>
          )}
