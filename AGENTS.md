...
Redis (caché, rate limiting, ventana de consenso, pub/sub) · Anthropic Java SDK, modelo `Codex-opus-5`
...
firma *"Generated with Codex"*, ni como autor o revisor de un PR, issue o comentario. Refuerzo
mecánico: `includeCoAuthoredBy: false` en `.Codex/settings.json`; si aun así ves un trailer de
...
```
/                       AGENTS.md · DESIGN.md · MEMORY.md · README.md · .mcp.json
.Codex/                skills/ · agents/ · settings.json
